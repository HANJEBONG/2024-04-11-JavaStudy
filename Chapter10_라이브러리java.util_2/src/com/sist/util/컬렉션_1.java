...
/*
 *      Collection : 배열을 대체 => 가변형 (저장갯수를 지정하지 않는다)
 *                                    -------------------- 신축성
 *      1. 컬렉션 프레임워크
 ...
 *         = 단점 : 모든 데이터를 저장이 가능하게 => Object 로 되어 있다 => 객체 형변환
 ...
 *                |                 |                |
 *            **ArrayList         **HashSet        Hashtabel ==> interface 구현한 클래스
...
public class 컬렉션_1 {
	...
	public static void main(String[] args) {
		...
		LinkedList list=new LinkedList(); // 가변형 => 데이터형 갯수를 지정하지 않는다
		/*
		 *    접근 속도가 느리다 / 추가 , 삭제가 빠르다
		 *    -------------
		 */
		// 1. 저장 => add()
		list.add("홍길동"); // 0
