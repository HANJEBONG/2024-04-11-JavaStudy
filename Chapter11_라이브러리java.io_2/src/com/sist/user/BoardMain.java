...
public class BoardMain extends JFrame implements ActionListener,MouseListener{
	...
	public BoardMain() {
    	...
    	bDetail.b1.addActionListener(this); // 목록
    	bDetail.b2.addActionListener(this); // 삭제
    	bDetail.b3.addActionListener(this); // 수정
    	bUpdate.b1.addActionListener(this); // 수정하기
    	bUpdate.b2.addActionListener(this); // 수정취소
	...
	public void listPrint() {
		...
		for(int i=0;i<list.size();i++) { // 최신것을 제일 위로 올려준다
			Board b=list.get(i);
			String[] data= {String.valueOf(b.getNo()),b.getSubject(),b.getName(),new SimpleDateFormat("yyyy-MM-dd").format(b.getRegdate()),String.valueOf(b.getHit())};
