 ...
 *        -------------------
 *        => 문법과 어휘
 *        => 속어 , 문장 => 라이브러리(자바를 사용해서 프로그램을 만들 수 있게 미리 제작한 클래스의 집합)
 *                                                            -----------------
 *                                                            API (Application Program Interface)
 *           -------- 회화
 *        => java.lang,java.util,java.io,java.sql
 *           -------------------------------------- 290page
 *           => 사용하기 위해서는 반드시 import를 사용해서 클래스 읽기 (예외:java.lang은 import 생략)
 *     => java.lang
 *        1.Object
 *          1) 모든 클래스의 상속을 내린 클래스 (최상위 클래스) => extands Objects
 *                                                    ---------------
...
public class 라이브러리_1 {
	...
	public static void main(String[] args) {
        ...
        /*int[] arr= {10,20,30};
        int[] temp=arr; //참조 (temp가 바뀌면 arr도 바뀜)
