...
//    	    System.out.println(m);
	...
	public static void main(String[] args) {
		...
		/*System.out.println("--------- 출연자명 검색 ---------");
		System.out.print("출연자명 입력:");
		String actor=scan.next();
		int count=0;
		for(Movie movie:m.movies) {
			if(movie.acter.contains(actor)) {
				System.out.println(movie.title+"("+movie.acter+")");
				count++;
			}
		}
		System.out.println("출연한 영화 총 "+count+"편 입니다");
		...
		System.out.println("총 "+count2+"편 입니다");
		String age="15세";
		int count3=0;
		for(Movie movie:m.movies) {
			if(movie.grade.contains(age)) {
				System.out.println(movie.mno+"."+movie.title);
				count3++;
			}
		}
		System.out.println("15세 이상 영화는 총 "+count3+"편 입니다");
		...
		System.out.println("총 "+count4+"편 입니다");
