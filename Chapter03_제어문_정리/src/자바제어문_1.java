 ...
 *                          = 로그인(X) => 로그인 요청 => 회원가입
 *                      if(isLogin()){
 *                          main.jsp 이동 => true 일때 처리
 *                      }
 *                      else {
 *                          login.jsp 이동 => false 일때 처리
 *                      }
 ...
 *                  }     | false
 *                  else{
 *                      조건이 없는 경우 처리되는 문장 => 필요가 없는 경우 생략이 가능
 *                  }
 *               다중 조건문을 간결하게 만든 제어문
 *               선택문 => switch~case
 *                     게임 => key 입력값
...
public class 자바제어문_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("===== do~whlie 반복문 중단 ======");
		i=1;
		do {
			if(i==3)break;
			System.out.println("i="+i);
