...
public class GoodsDetailPanel extends JPanel implements ActionListener,ItemListener{
	...
	public void print(int no) {
		...
		la3.setText("<html><font color = gray>"+vo.getGoods_sub()+"</b><font></html>" );
		la4.setText("<html><font color = orange>"+vo.getGoods_discount()+"%<font></html>");
		la5.setText(vo.getGoods_price());
		la6.setText("<html><font color=green> 첫구매 할인가 </font></html>");
	...
	public void itemStateChanged(ItemEvent e) {
		if(e.getSource() == box) {
			...
			price = price.substring(price.indexOf(":")+1); // : 다음부터 가지고와라 하면 가격을 가져옴
