 ...
 *                    => 단어가 2개 일때
 *                       fileName() => 두번째 시작하는 단어 대문자로 시작 (헝거리식 표기법)
 *                                     _  
 *                 ** 결과값 / 요청값을 받는다
 *                    ---    ---
 *                    리턴형   매개변수
 ...
 *                 --------------------------
 *                       X           O
 *                      void println("aaa") => 결과값이 없는 경우 void
 *                 --------------------------
 *                       X           X
 ...
 *                                | 컴파일러가 자동으로 추가
 *              ** 클래스
 *                 = 사용자 데이터형 => 데이터만 저장할 목적 => ~VO,~DTO,~Been
 *                 = 액션 클래스 => 메소드 (기능만) => ~DAO,~Manager
 *                    | 중심
 *                      => 실습 (2주) => 관리자페이지 만들어서 제출
 *                         댓글형 게시판 만들어서 제출
 *                         ..
 *                         예약 , 결제 ...
 *                 -------------------------------------------------
...
public class 메소드_1 {
	...
	//      공유    결과값이 없다 메소드명   매개변수	
		...
		// main=>시작점
		System.out.println("dlsplay 진입전");
		display("홍길동");// 메소드 호출
		// 리턴형 , 매개변수
		System.out.println("=======================");
		System.out.println("dlsplay 진입전");
