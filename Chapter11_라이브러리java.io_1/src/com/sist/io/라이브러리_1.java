 ...
 *       6. BufferedInputSream / BufferedOutpurStream
 *       7. ObjectInputStream / ObjectOutputStream
 *       ----------------------------------------------------
 *        InputStream / OutputStream : 읽기 / 쓰기 => 1byte 씩 읽기를 한다 => 한글이 깨진다 => 다른 파일
 *                  => 업로드 / 다운로드
 *                  => 바이트 스트림
 ...
 *             File dir=new ("경로명") => 폴더에 대한 정보를 가지고 온다
 ...
 *             ***9) 파일 정보를 한번에 읽기(최대) => listFiles():File[]
