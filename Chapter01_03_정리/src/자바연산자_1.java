 ...
 *             System.out.println(++a) => 출력전에 증가 => 11
 *          = 부정연산자 : 조건문에서 주로 사용
 *             무조건 결과값 : true/false ==> !(반대효과)
 *             !(6==8 && 6>5)
 *             => 예약일이 아닌 날 ... 
 ...
 *         %>
 *         
 *         <a href="list.jsp?page=<%=curpage>1curpage-1:curpage%>">
 *         
