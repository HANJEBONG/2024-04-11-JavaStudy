 ...
 *             => false면 건너뛴다
 *         }
 *         => 오류 처리 , 검색이 입력이 없는 경우 , 범위를 벗어난 경우 ....
 *         => 입력창이 있는 경우
 ...
 *            반복 수행 문장 3
 *          }
 *          1  2  3  4  2  3  4  2  3  4 => 2가 false일 경우 종료
 *       => 횟수가 지정되지 않은 경우 => while
 *         => 순차적으로 수행
 *            초기값 1
 *            while(조건문) 2
 *            {
 ...
 *                                      while => 조건식 => 잘못하면 무한 루프 => 처음부터 다시 실행
 *                     |
