 ...
 *            = 보안 => 데이터를 보호 => 캡슐화
 *         ------------------------------------------
 *            객체지향의 3대 특성 : 캡슐화 => 변수관련 => private변수 / 메소드를 이용해서 접근하는 방식
 *                             상속 => 재사용 기법
 *                             다형성 => 오버로딩,오버라이딩 => 유지보수 (기능변경=메소드관련)
 *            ** 상속을 사용하면 결합성 높고 , 제약조건이 많이 존재 , 메모리가 커진다 , 속도가 늦다 => 가급적이면 사용하지 않는다
 *               => 단일 상속
 ...
 *                       ---------------------------- 인스턴스 , 생성자에서 사용이 가능
 *                   *** static 메소드나 static 초기화 블록은 this 를 가지고 있지 않다
 *                   *** new 를 이용해서 객체 생성시에 => this가 생성
 *                       ---- JVM에 의해서 자동 생성
 */
public class MainClass_1 {
    ...
    public static void aaa() {
    	// System.out.println("this="+this); // static 은 모든 객체가 공통으로 사용 => this를 사용할 수 없다
    }
	public static void main(String[] args) {
		// TODO Auto-generated method stub
        // 객체 생성
		MainClass_1 m=new MainClass_1();
		// this=m => JVM => 자동으로 객체 주소값 대입
		System.out.println("m="+m);
		// 객체 생성시마다 this가 생성이 된다 => 자신의 클래스 객체를 나타낸다
		m.numData(100);
	}
