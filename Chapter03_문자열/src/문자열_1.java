 ...
 *             | 변수형
 *      | 데이터형
 *      String name=new String("홍길동"); => 문자열은 제한이 없다
 *   2) 연산자
 *      + : 문자열 결합
 *      String name="홍길동";
 *      String etc="입니다";
 ...
 *      ***= length() : 문자갯수
 *      = replace() : 문자 변환
 *      ***= substring() : 문자를 자르는 경우에 사용 (출력한 범위가 일정수를 벗어났을때 사용)
 *      = toUpperCase() : 대문자 변환
 *      = toLowerCase() : 소문자 변환
 *      ***= trim() : 공백문자 제거(좌우의 공백)
...
public class 문자열_1 {
	...
	public static void main(String[] args) {
		 ...
		 *   0123456
		 */
		System.out.println("문자 추출:"+alpha.charAt(3));
